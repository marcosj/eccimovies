...
<?php echo $this->Form->create('ActorsProduct'); ?>
	<fieldset>
		<legend><?php echo __('Edit Actors Product'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('ActorsProduct.id')), array('confirm' => __('Are you sure you want to delete # %s?', $this->Form->value('ActorsProduct.id')))); ?></li>
